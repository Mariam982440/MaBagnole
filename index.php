    ...
    <nav class="bg-slate-900 text-white shadow-xl">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 items-center">
                <a href="index.php" class="text-blue-400 border-b-2 border-blue-400 pb-1">Location</a>
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <form action="index.php" method="GET" class="flex flex-col md:flex-row gap-4 items-center">
                ...
                <?php if($search || $cat_id): ?>
                    <a href="index.php" class="text-sm text-red-500 hover:underline">Réinitialiser</a>
                <?php endif; ?>
            </form>
        </div>
    </section>
